...
class AddUser extends Component {
  ...
  async componentDidMount() {
    ...
    if (this.props.user !== undefined) {
      ...
      this.setState({
        userid: res.id,
        name: res.name,
        address: res.address === undefined ? "" : res.address,
        avatar: res.Image,
      });
    }
  }
  ...
  async handleSubmit() {
    if (
      ...
      if (this.props.updated) this.setState({ visibleSuccess: true });
  ...
  async handleDelete() {
    ...
    if (this.props.deleted) this.setState({ visibleDeleteSuccess: true });
    else this.setState({ visibleDeleteDanger: true });
  }
      ...
      <div>
        <Container>
          ...
          <Row>
            ...
            <Alert
              color="success"
              isOpen={this.state.visibleDeleteSuccess}
              toggle={this.onDismissDeleteSuccess}
            >
              User has been deleted successfully!
            </Alert>
            <Alert
              color="danger"
              isOpen={this.state.visibleDeleteDanger}
              toggle={this.onDismissDeleteDanger}
            >
